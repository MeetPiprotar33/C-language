    ...
    while (flag==true){
        ...
        switch (choice){
            ...
            case 3:
                ...
                break;
            case 4 :
                printf("Through what choice you want to inquire about the Book :\n");
                ...
                switch(choice_inquiry){
                    ...
                    case 1:
                        ...
                        if (roll_present1==true){
                            ...
                            printf("%d\t",library[roll_row1][0]);
                            printf("%d\t",library[roll_row1][1]);
                            printf("%d\t",library[roll_row1][2]);
                            printf("%d\t",library[roll_row1][3]);
            ...
            case 5 :
                ...
                if(library[book_change_row][4]==0){
                    ...
                    printf("\nSorry you have already submitted the book..");
                }
                break;
