...
int main(){
    ...
    strcpy(accountlist[4].fname,"SAVAN");
    strcpy(accountlist[4].lname,"PATEL");
    ...
    while(true){
        ...
        if (strcmp(login,"ADMIN")==0){
                ...
                if (strcmp(adminPassword,"9106669489")==0){
                    ...
                    while(adminloop==true){
                        ...
                        if (Adminchoice==1){
                            ...
                            int Accountdelete;
                            bool accountdeletable=false;
                            int accountdeleteaccessindex;
                            ReEnterAccountForDelete:
                            printf("ENTER THE ACCOUNT NUMBER YOU WANT TO DELETE :\t");
                            scanf("%d",&Accountdelete);
                            for (int i=0;i<serialNumber;i++){
                                if(accountlist[i].accNumber==Accountdelete){
                                    accountdeletable=true;
                                    accountdeleteaccessindex=i;
                                }
                            }
                            if (accountdeletable==true){
                                for (int i=accountdeleteaccessindex;i<serialNumber;i++){
                                ...
                                int accountdeletechoice;
                                deleteinvalidinput:
                                printf("SORRY ENTERED ACCOUNT IS NOT AVAILABLE.\n");
                                printf("ENTER CHOICE \n");
                                printf("1.RE ENTER THE ACCOUNT NUMBER\n");
                                printf("2.EXIT");
                                scanf("%d",&accountdeletechoice);

                                if (accountdeletechoice==1) goto ReEnterAccountForDelete;
                                else if(accountdeletechoice==2) goto DeleteAccountExitTransfer;
                                else{
                                    printf("INVALID INPUT.\n");
                                    goto deleteinvalidinput;
                                }
                            }
                            ...
                            int AccountBalanceEdit;
                            bool accountBalanceEditable=false;
                            int accountBalanceEditaccessindex;
                            ReEnterAccountForBalanceEdit:
                            printf("ENTER THE ACCOUNT NUMBER YOU WANT TO EDIT BALANCE :\t");
                            scanf("%d",&AccountBalanceEdit);
                            for (int i=0;i<serialNumber;i++){
                                if(accountlist[i].accNumber==AccountBalanceEdit){
                                    accountBalanceEditable=true;
                                    accountBalanceEditaccessindex=i;
                                }
                            }
                            if (accountBalanceEditable==true){
                                int shortidecating=accountlist[accountBalanceEditaccessindex].balance;
                                int editedamount=0;
                                printf("THE EXISTING BALANCE FOR ACCOUNT NUMBER :- %d IS => %d\n",AccountBalanceEdit,shortidecating);
                                AmountIsInNegative:
                                printf("ENTER THE CHANGED AMOUNT \t");
                                scanf("%d",&editedamount);
                                
                                if (editedamount>0){
                                    accountlist[accountBalanceEditaccessindex].balance=editedamount;
                                    printf("ACCOUNT BALANCE HAS BEEN CHANGED SUCCESSFULLY\n");
                                    printf("ACCOUNT DETAILS AFTER BALANCE EDIT :\n");
                                    printone(accountlist[accountBalanceEditaccessindex]);
                                }
                                else{
                                    printf("PLEASE ADD AMOUNT IN POSITIVE.\n");
                                    goto AmountIsInNegative;
                                }

                                
                            }else{
                                int accountBalanceEditchoice;
                                BalanceEditInvalidinput:
                                printf("SORRY ENTERED ACCOUNT IS NOT AVAILABLE.\n");
                                printf("ENTER CHOICE \n");
                                printf("1.RE ENTER THE ACCOUNT NUMBER\n");
                                printf("2.EXIT");
                                scanf("%d",&accountBalanceEditchoice);

                                if (accountBalanceEditchoice==1) goto ReEnterAccountForBalanceEdit;
                                else if(accountBalanceEditchoice==2) goto DeleteAccountExitTransfer;
                                else{
                                    printf("INVALID INPUT.\n");
                                    goto BalanceEditInvalidinput;
                                }
                            }
                            ...
                            printf("THANK YOU BOSS FOR VISIT...\n");
                            goto adminidwrongtransfer;
                        }
                        else{
            ...
            printf("THANK YOU FOR VISITING M33T'S ATM..");
            break;
